...
export function PageHeader({ title, subtitle, actions, breadcrumbs, divider = false, className }) {
  return (
    <div className={cn('mb-6', divider && 'border-b border-border pb-5', className)}>
      {breadcrumbs && (
