...
const CurrenciesPage = lazy(() => import('@/pages/app/CurrenciesPage'))
...
const CustomerStatementPrintPage = lazy(() => import('@/pages/app/CustomerStatementPrintPage'))
        ...
        <Routes>
          ...
          >
            ...
            <Route
              ...
              element={
                <ProtectedRoute permission={PERMISSIONS.CURRENCY_READ}>
                  <CurrenciesPage />
                </ProtectedRoute>
              }
            />
          ...
          <Route
            path={ROUTES.CUSTOMER_STATEMENT_PRINT()}
            element={
              <ProtectedRoute>
